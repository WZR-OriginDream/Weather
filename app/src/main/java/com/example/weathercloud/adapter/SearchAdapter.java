...
import com.example.weathercloud.view.activity.SearchActivity;
...
public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void saveData(Lang lang, final String key, final String cid) {
        QWeather.getGeoCityLookup(activity, cid, Range.WORLD, 1, lang, new QWeather.OnResultGeoListener() {
            @Override
